# SylNet Database Schema (Version 1.0)

এই ডকুমেন্টটি SylNet-এর সম্পূর্ণ ডাটাবেজ ডিজাইন — এখন পর্যন্ত তৈরি প্রোটোটাইপের সব ফিচার (Majlis, Post, Reaction, Comment, Share, Profile, News, People You May Know) এবং Vision Document-এ উল্লেখিত ভবিষ্যৎ ফিচারগুলো (OTP Login, Report System, Notification) বিবেচনা করে বানানো হয়েছে।
...
SylNet-এর সবচেয়ে গুরুত্বপূর্ণ ফিচার। `parent_majlis_id` দিয়ে হায়ারার্কি তৈরি হয়: **ইউনিয়ন → উপজেলা → জেলা**।
